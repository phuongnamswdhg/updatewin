...
demo_login /
           ...
           -chức năng ghi nhớ đăng nhập : luu lại thông tin dăng nhập thành công để lần sau truy cập lại thì sẽ tự dộng đăng nhập
-->
<!--login.php-->
<?php
session_start();
...
if (isset($_POST['login'])) {
    ...
    if (empty($error)) {
        ...
        if ($password == 123) {
            //-  xử lý ghi nhớ đăng nhập điều kiện là login thành công và có tình checkbox
